...
client = commands.Bot(description="I am ImmortalBOT and i love being immortal!", command_prefix="immortal ", pm_help = True)
...
@client.event
async def on_member_join(member):
    role = discord.utils.get(membe.server.roles, name='Immortal')
